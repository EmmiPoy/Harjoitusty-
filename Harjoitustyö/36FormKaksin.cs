...
{
    public partial class Kaksin36Form : Form
    {
            ...
            if (klikattuLabel != null)
            {
                ...
                if (ekaKlikkaus.Text == tokaKlikkaus.Text)  //Korteissa samat kuvat ja vuoro pysyy pelaajalla
                {
                    ...
                    if (pelaaja1)                   // jos vuorossa oleva pelaaja on pelaaja1
                    {
                        ...
                        if (loydetytParit == 18)                                 //kun kaikki oikeat parit on löydetty, tarkastetaan onko kumpi pelaajista voittaja vai tuliko tasapwli
                        {
                            ...
                            else if (pisteet1 == 9 && pisteet2 == 9)        //jos pelaajilla on saa määrä pisteitä = tasapeli
                            {
                    ...
                    else
                    {
                        ...
                        if (loydetytParit == 18)                             //kun kaikki parit löydetty
                        {
                            ...
                            else if (pisteet1 == 9 && pisteet2 == 9)        //tasapeli ja kasvatetaan laskureita sen mukaan 
                            {
                                tasapelit1++;
                                tasapelit2++;
                                pelatutPelit1++;
