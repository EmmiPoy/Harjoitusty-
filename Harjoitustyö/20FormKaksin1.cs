...
{
    public partial class Kaksin20Form1 : Form
    {
        ...
        public void lblKeskivaikea_Click(object sender, EventArgs e)
        {
            ...
            if (timerKeskivaikea.Enabled == true)
            {
                return;
            }
            ...
            if (klikattuLabel != null)
            {
                ...
                if (ekaKlikkaus.Text == tokaKlikkaus.Text)  //Korteissa samat kuvat ja vuoro pysyy pelaajalla
                {
                    ...
                    if (pelaaja1)                   // jos vuorossa oleva pelaaja on pelaaja1
                    {
                        ...
                        tlsPelaaja.Text = "Pelaaja1: " + pisteet1.ToString();   //Ilmoitetaan toolstripissä pelaajan senhetkinen pistemäärä
                        if (loydetytParit == 10)                                 //kun kaikki oikeat parit on löydetty, tarkastetaan onko kumpi pelaajista voittaja vai tuliko tasapwli
                        {
                            ...
                            else if (pisteet1 == 5 && pisteet2 == 5)        //jos pelaajilla on saa määrä pisteitä = tasapeli
                            {
                    ...
                    else
                    {
                        ...
                        if (loydetytParit == 10)                             //kun kaikki parit löydetty
                        {
                            ...
                            else if (pisteet1 == 5 && pisteet2 == 5)        //tasapeli ja kasvatetaan laskureita sen mukaan 
                            {
                                tasapelit1++;
                                tasapelit2++;
                                pelatutPelit1++;
            ...
            List<string> kuvakkeet = new List<string>()
        {
            ...
            pisteet2 = 0;
            loydetytParit = 0;
            tlsPelaaja.Text = "Pelaaja1: " + pisteet1.ToString();
            tlsPelaaja2.Text = "Pelaaja2: " + pisteet2.ToString();
